...
import { AlertCircle, TrendingUp, CheckCircle2, Target, Sparkles, FileDown } from "lucide-react";
...
export const IssueAnalysisDisplay = ({ analysis, repositoryName }: IssueAnalysisDisplayProps) => {
  const { toast } = useToast();
  
  const handleExportPDF = () => {
    try {
      exportAnalysisToPDF({ repositoryName, analysis });
      toast({
        title: "PDF Generated",
